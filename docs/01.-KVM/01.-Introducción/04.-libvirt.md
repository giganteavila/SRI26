...
Por tanto, `libvirt` **simplifica la gestión de comandos complejos de KVM/QEMU**, convirtiéndola en la forma preferida de interactuar con las máquinas virtuales para la mayoría de los usuarios y herramientas de alto nivel.
